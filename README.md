...
- Возможность установки плагинов дает **огромную вариативность** модификации функционала под разные нужды.
...
- Выбран самый простой и при этом мощный язык для таких целей - _Python_.
